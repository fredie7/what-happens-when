...
The firewall serves two purposes. It prevents nasty things on the internet from
coming into the intranet, and it also prevents sensitive information from being sent
out onto the internet. The firewall is designed to let in only those packets that meet
it's criteria. Port 80 receives packets from the internet to the webserver and any attempt 
